    ...
    useEffect(()=>{
      ...
      //fetching previous week's transaction data
       const getWeeklyData = async()=>{
        try{
            const res = await axios.get(API_ENDPOINTS.GET_WEEKLY_TRANSACTION(user._id))
       ...
       const getMonthlyData = async()=>{
        try{
            const res = await axios.get(API_ENDPOINTS.GET_MONTHLY_TRANSACTION(user._id))
       ...
       const getYearlyData = async()=>{
        try{
            const res = await axios.get(API_ENDPOINTS.GET_YEARLY_TRANSACTION(user._id))
       ...
       const getCategory = async()=>{
        try{
          const res= await axios.get(API_ENDPOINTS.GET_CATEGORY_WISE_TRANSACTION(user._id))
