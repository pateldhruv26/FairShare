...
useEffect(()=>{
  ...
  const ifnocategselect=async()=>{
    try{
              const res = await axios.get(API_ENDPOINTS.GET_TRANSACTIONS(user._id));
...
// console.log(datat)
   //function to retrieve user transactions with filter
    const handleFilter = e=>{
        ...
        try{
          const res = await axios.post(API_ENDPOINTS.GET_TRANSACTIONS_BY_FILTER,{filterInput})
    ...
    //function to send mail
      const mailsend=async()=>{
        try{
          ...
          console.log(reqmail)
          const res = await axios.post(API_ENDPOINTS.SEND_MAIL,{reqmail})
      ...
      const addBadge=async(img)=>{
        try{
          console.log(img)
          const res = await axios.post(API_ENDPOINTS.ADD_BADGE(user._id),{img})
    ...
    const getTotalStats = async()=>{
      try{
        ...
        console.log(result);
        const res = await axios.get(API_ENDPOINTS.GET_TOTAL_STATS(user._id))
        console.log(res.data)
        setStats(res.data)
      }catch(err){
        console.log(err)
  ...
  useEffect(()=>{
    const getTrans = async()=>{
      try{
        const res = await axios.get(API_ENDPOINTS.GET_TRANSACTIONS(user._id))//add user Id
        console.log(res.data)
    ...
    const handleSubmit = async(e)=>{
      ...
      try{
        ...
        const res = await axios.post(API_ENDPOINTS.ADD_TRANSACTION,{userId:user._id,type,category,desc,date,currency,amount})
        console.log(res.data)
