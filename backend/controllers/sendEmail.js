...
export function sendEmail (recievermail){
    ...
    return new Promise((resolve, reject) => {
      ...
      const mail_configs = {
        ...
        subject: "FairShare dues reminder",
        html: `<!DOCTYPE html>
  <html lang="en" >
  <head>
    <meta charset="UTF-8">
  ...
  <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
    <div style="margin:50px auto;width:70%;padding:20px 0">
      <div style="border-bottom:1px solid #eee">
        <a href="" style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600">FairShare</a>
      </div>
      <p style="font-size:1.1em">Hi,</p>
              <p>Thank you for choosing FairShare. Clear your dues as soon as possible</p>
      <h2 style="background: #00466a;margin: 0 auto;width: max-content;padding: 0 10px;color: #fff;border-radius: 4px;">nicee</h2>
              <p style="font-size:0.9em;">Regards,<br />FairShare</p>
